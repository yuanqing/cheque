...
test('isFloat', function(t) {
  ...
  t.ok(fn(1), 'number 1');
  t.ok(fn(-1), 'number -1');
  t.ok(fn(42), 'number decimal');
  t.ok(fn(-42), 'number negative decimal');
  t.ok(fn(052), 'number octal');
  t.ok(fn(-052), 'number negative octal');
  t.ok(fn(0x2a), 'number hex');
  t.ok(fn(-0x2a), 'number negative hex');
  t.ok(fn(3.14), 'number float');
  t.ok(fn(-3.14), 'number negative float');
  t.ok(fn(3e14), 'number exponent');
  t.ok(fn(-3e14), 'number negative exponent');
  t.ok(fn(Number.MIN_VALUE), Number.MIN_VALUE, 'Number.MIN_VALUE');
  t.ok(fn(Number.MAX_VALUE), Number.MAX_VALUE, 'Number.MAX_VALUE');
